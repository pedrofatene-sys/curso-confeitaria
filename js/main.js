...
const channels = [
    { id: 'hSt0Q-GxoSc', name: 'Introdução' },
    { id: 'yPLn81qHH9U', name: 'A MELHOR MASSA CHIFFON BRANCA | MUDE SUA VIDA COM ESSA MASSA' },
    { id: 'va87cckMEic', name: 'O SEGREDO" DE COMO MONTAR E PRENSAR BOLO DE ANIVERSÁRIO... A MELHOR AULA!!!' },
    { id: 'uXp21iyjiYw', name: 'CHANTININHO NO PONTO PERFEITO...NUNCA MAIS ERRE ' },
    { id: 'lVqVwJVx2Pg', name: 'DEPOIS DESSE VÍDEO, NUNCA MAIS VOCÊ TERÁ DIFICULDADES EM ALISAR E QUINAR UM BOLO! A MELHOR AULA!' },
    { id: 'xQQIy3-la1Q', name: 'MASSA CHIFFON DE CHOCOLATE REBECA POLL' },
    { id: 'lVqVwJVx2Pg', name: 'DEPOIS DESSE VÍDEO, NUNCA MAIS VOCÊ TERÁ DIFICULDADES EM ALISAR E QUINAR UM BOLO! A MELHOR AULA!' },
    { id: 'xQQIy3-la1Q', name: 'MASSA CHIFFON DE CHOCOLATE REBECA POLL' },
    { id: 'w0qSGrurU_A', name: 'GANACHE PARA DRIP CAKE' },
    { id: 'cg603WyrtpI', name: 'NÃO ERRE MAIS NA MONTAGEM DE BOLO COM MORANGOS FRESCOS ' },
    { id: 'XKxnNd_KM9Y', name: 'MÉTODO DE COMO FAZER O BOLO FENDA PERFEITO | DECORAÇÃO EM CHANTININHO' },
    { id: 'elKUmLK06Wo', name: 'MÉTODO PARA FAZER MASSA AMANTEIGADA PERFEITA... ESSA MASSA VAI TE SALVAR' },
    { id: 'L9hFYJoUGCY', name: 'MONTAGEM DE BOLO COM GELEIA DE MORANGO | MASSA DE BOLO AMANTEIGADA' },
    { id: 'o4RM0szAUIQ', name: 'DECORAÇÃO DE BOLO | FÁCIL E DELICADA | RECHEIO NINHO/GELEIA DE MORANGO | GLOW CAKE' },
    { id: 'CPF6ePIvTlQ', name: 'DIREITOS POLITICOS - PartCOMO COMEÇAR NA CONFEITARIA | COM POUCO DINHEIRO' },
    { id: 'cQ6WrJQMmi8', name: 'MASSA CHIFFON BRANCA | COMO FAZER EM UMA FÔRMA SÓ' },
    { id: 'ED4AiqALOIg', name: 'CHANTININHO PERFEITO COMO TINGIR CORES FORTES, SEM PERDER O PONTO. | EFEITO DEGRADÊ' },
    { id: 'x-XkRLa3TNI', name: 'ESSA DECORAÇÃO FICOU MARAVILHOSA!!! ESTÁ EM ALTA | BOLO CHANTININHO' },
    { id: 'IeJQWQbCZwM', name: 'USE ISTO NA DECORAÇÃO DE SEUS BOLOS E SURPREENDA-SE | PINTURA EM CASQUINHA DE SORVETE' },
    { id: 'dpj-enDoCHU', name: 'ESSA TÉCNICA VAI DEIXAR SEU BOLO MARAVILHOSO |Aprenda a Texturizar Chantininho' },
    { id: 'jjkI3DMRp6s', name: 'MASSA AMANTEIGADA DE CHOCOLATE PARA BOLO DE ANIVERSÁRIO | FOFINHA ÚMIDA' }
];
